...
\section{The inconsistency, precisely}
\label{sec:bug}
...
MLE independently). The strict-\code{xfail} test
\code{test\_extra\_mode\_multi\_stage\_is\_consistent} pins this defect.

\paragraph{Fix directions (to be designed before coding).}
\begin{enumerate}
